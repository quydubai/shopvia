-- admin123 và demo hash bcrypt cost=10
INSERT OR IGNORE INTO users (username, email, password, balance, role) VALUES
  ('admin','admin@clone99.com','$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy',10000000,'admin'),
  ('demo','demo@clone99.com','$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',500000,'user');
...
INSERT OR IGNORE INTO products (category_id,name,slug,description,price,stock,data_content) VALUES
...
INSERT OR IGNORE INTO settings (key, value) VALUES
  ('site_name','HuynhQuyMedia.COM'),
  ('bank_info','{"bank_name":"MB Bank","account_number":"0834724567","account_holder":"HUYNHQUYMEDIA","note_format":"NAP [username]"}'),
  ('crypto_address','{"network":"TRC20 (USDT)","address":"TXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx","rate":"1 USDT = 25,000 VND"}'),
  ('min_recharge','10000'),
  ('telegram','@quydubai'),
  ('phone','0834724567'),
  ('smtp','{"host":"smtp.gmail.com","port":587,"user":"","pass":"","from_name":"HuynhQuyMedia"}');
